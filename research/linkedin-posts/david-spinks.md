...
## Post 1 — Building a Community Business 101, Day 1: Who are you building for?
**Date**: 2026-06-07 (approx, "2weeks")
**Link**: https://www.linkedin.com/posts/davidspinks_building-a-community-business-101-day-1-activity-7467254388118700032-7XCd?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFZQPK8BcXnoBwVbAgFxMUiN2Lddij6pz3k
...
**Why I picked this**: Spinks reframes the founding decision behind any community-led business as identity-driven rather than market-driven. For a B2B SaaS founder, this directly challenges the common assumption that you can simply "spin up a community" as a growth channel. The three archetypes he describes (peer-builder, expert-teacher, outside opportunist) map cleanly onto how different SaaS companies approach community, and explain why some communities feel alive while others feel performative.

---

## Post 2 — Building a Community Business 101, Day 5: The commitment curve

**Date**: 2026-06-13 (approx, "2weeks")
**Link**: https://www.linkedin.com/posts/davidspinks_building-a-community-business-101-day-5-activity-7468650352410603520-vbZr?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFZQPK8BcXnoBwVbAgFxMUiN2Lddij6pz3k
**Engagement**: 22 likes, 2 comments
...
This is a tool I first learned from Douglas Atkin who led community for Meetup and Airbnb, where he used this model.
...
**Why I picked this**: This is the most practical framework in the post set. The commitment curve is widely referenced in community-led growth theory, but Spinks gives a concrete 3-step process to actually build one, plus the exact invitation-based progression mechanism. For B2B SaaS, this directly maps to lifecycle marketing without the transactional framing. The attribution to Douglas Atkin (Meetup, Airbnb) also signals that Spinks is sharing operator-tested tools, not theory.

---

## Post 3 — Building a Community Business 101, Day 6: Community creep

**Date**: 2026-06-14 (approx, "1week")
**Link**: https://www.linkedin.com/posts/davidspinks_building-a-community-business-101-day-6-activity-7470143071662403584-suFn?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFZQPK8BcXnoBwVbAgFxMUiN2Lddij6pz3k
**Engagement**: 18 likes, 4 comments

building a community business 101 - day 6
...
**Why I picked this**: Most community advice focuses on what to add. This one is about what to cut, which is the harder and rarer skill. The "community creep" framing is a sharp anti-pattern that B2B SaaS teams should pay attention to, since the same dynamic shows up in product feature bloat and content sprawl. The "funeral for the program" tactic is creative and emotionally intelligent, exactly the kind of operator wisdom you can't get from generic CLG playbooks.
