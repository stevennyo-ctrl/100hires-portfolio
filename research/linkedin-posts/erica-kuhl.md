...
## Post 1 — The land grab for trust: why community and education content become the moat in the answer engine era

**Date**: ~April 2026 (2 months ago)
**Link**: https://www.linkedin.com/posts/ericakuhl_aeo-unplugged-activity-7445477712183545856-pNgs?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFZQPK8BcXnoBwVbAgFxMUiN2Lddij6pz3k
**Engagement**: 67 reactions, 19 comments, 2 shares
...
## Post 2 — Community as the answer to the "it will just become a complaint forum" objection

**Date**: ~February 2026 (4 months ago)
**Link**: https://www.linkedin.com/posts/ericakuhl_i-dont-want-to-start-a-community-itll-activity-7429917634999214080-fNOY?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFZQPK8BcXnoBwVbAgFxMUiN2Lddij6pz3k
**Engagement**: 148 reactions, 45 comments, 8 shares
...
**Why I picked this**: The cleanest objection-busting playbook in the set, anchored to a real Salesforce crisis with named tactics: aggregate feedback through trusted leaders, enroll super users as a moderation extension, leadership publicly owns the mistake. Every founder considering community has the "it will become a complaint forum" reflex, and this post converts that fear into a build-well argument with mechanics attached. The self-regulating community frame plus the super-user partnership model is reusable across company stage.

---

## Post 3 — The new community mandate: from siloed forum to retention, support, product, and scale

**Date**: ~March 2026 (3 months ago)
**Link**: https://www.linkedin.com/posts/ericakuhl_on-demand-webinar-community-outlook-2026-activity-7431785549180391424-n8zZ?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFZQPK8BcXnoBwVbAgFxMUiN2Lddij6pz3k
**Engagement**: 134 reactions, 16 comments, 13 shares
...
**Why I picked this**: Highest share-to-like ratio in the set at roughly 10 percent, which is the strongest signal that practitioners are passing it along as working framework rather than just a viral take. The five concrete jobs Erica assigns to community (scale, support deflection, product input, customer stories, retention) collapse into one slide for justifying community investment to a founder or CFO. Short, dense, and immediately usable in a B2B SaaS GTM deck.